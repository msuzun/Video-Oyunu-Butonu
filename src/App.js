...
export default function App() {
  ...
  let btn = gameRunning ? <button onClick={handleClick} className="video-game-button">Play</button> : <button onClick={handleClick} className="video-game-button">Pause</button>
  /* Challenge
